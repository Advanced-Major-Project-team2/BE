...
public class ReviewService {
    ...
    public ReviewCreateResponseDto createReview(
        ...
        validateReviewAfter24Hours(gathering);
    ...
    private void validateReviewAfter24Hours(Gathering gathering) {
        if (LocalDateTime.now().isBefore(gathering.getUpdatedAt().plusHours(24))) {
            throw new CustomException(ReviewErrorCode.REVIEW_NOT_YET_ALLOWED);
        }
    }
