        ...
        return HomeResponseDto.builder()
                .recommended(
                        gatheringService.getGatheringList(
                                userId, null, page, size, GatheringSort.RECOMMEND.getSort(), null))
                .latest(
                        gatheringService.getGatheringList(
                                userId, null, page, size, GatheringSort.LATEST.getSort(), null))
                .popular(
                        gatheringService.getGatheringList(
                                userId, null, page, size, GatheringSort.POPULAR.getSort(), null))
                .build();
    }
}
