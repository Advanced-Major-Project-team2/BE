...
public class ParticipationService {
    ...
    public void cancelParticipation(Long gatheringId, Long userId) {
        ...
        validateCancellationDeadline(gathering);
    ...
    private void validateCancellationDeadline(Gathering gathering) {
        if (LocalDateTime.now().isAfter(gathering.getDate().minusMinutes(30))) {
            throw new CustomException(ParticipationErrorCode.CANCELLATION_DEADLINE_PASSED);
        }
    }
